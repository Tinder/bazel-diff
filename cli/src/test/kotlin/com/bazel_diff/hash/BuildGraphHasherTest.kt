...
class BuildGraphHasherTest : KoinTest {
    ...
    fun testRuleTargets() = runBlocking {
        ...
        assertThat(hash).containsOnly(
            "rule1" to TargetHash("Rule", "7b3149cbd2219ca05bc80a557a701ddee18bd3bbe9afa8e851df64b999155c5e", "2c963f7c06bc1cead7e3b4759e1472383d4469fc3238dc42f8848190887b4775", emptyList()),
            "rule2" to TargetHash("Rule", "24f12d22ab247c5af32f954ca46dd4f6323ab2eef28455411b912aaf44a7c322", "bdc1abd0a07103cea34199a9c0d1020619136ff90fb88dcc3a8f873c811c1fe9", emptyList()),
        )
    }
    ...
    fun testSeedFilepaths() = runBlocking {
        ...
        assertThat(hash).containsOnly(
            "rule1" to TargetHash("Rule", "ddf7345122667dda1bbbdc813a6d029795b243e729bcfdcd520cde12cac877f1", "0404d80eadcc2dbfe9f0d7935086e1115344a06bd76d4e16af0dfd7b4913ee60", emptyList()),
            "rule2" to TargetHash("Rule", "41cbcdcbc90aafbeb74b903e7cadcf0c16f36f28dbd7f4cb72699449ff1ab11d", "6fe63fa16340d18176e6d6021972c65413441b72135247179362763508ebddfe", emptyList()),
        )
    }
    ...
    fun hashAllBazelTargets_directHashUnchangedByDeps() = runBlocking {
        ...
        val rule2 = createRuleTarget(name = "rule2", inputs = arrayListOf("rule1"), digest = "rule2Digest")
        val rule3 = createRuleTarget(name = "rule3", inputs = arrayListOf("rule2"), digest = "rule3Digest")
        ...
        val newRule1 = createRuleTarget(name = "rule1", inputs = ArrayList(), digest = "rule1Digest--changed")
    ...
    fun hashAllBazelTargets_directHashChangedBySrcFiles() = runBlocking {
        ...
        val rule1 = createRuleTarget(name = "rule1", inputs = arrayListOf("src1", "src2"), digest = "rule1Digest")
        val rule2 = createRuleTarget(name = "rule2", inputs = arrayListOf("src3", "rule1"), digest = "rule2Digest")
    ...
    fun hashAllBazelTargets_generatedSrcDoesNotContributeToDirect() = runBlocking {
        ...
        val rule2 = createRuleTarget(name = "rule2", inputs = arrayListOf("gen1"), digest = "rule2Digest")
        val targets = arrayListOf(rule1, src1, rule2)

        whenever(bazelClientMock.queryAllTargets()).thenReturn(targets)
        val baseHashes = hasher.hashAllBazelTargetsAndSourcefiles()

        val newRule1 = createRuleTarget(name = "rule1", inputs = emptyList(), digest = "rule1Digest--changed")
    ...
    fun hashAllBazelTargets_ruleTargets_ruleInputs() = runBlocking {
        ...
        assertThat(hash).containsOnly(
            "rule1" to TargetHash("Rule", "7b3149cbd2219ca05bc80a557a701ddee18bd3bbe9afa8e851df64b999155c5e", "2c963f7c06bc1cead7e3b4759e1472383d4469fc3238dc42f8848190887b4775", emptyList()),
            "rule2" to TargetHash("Rule", "24f12d22ab247c5af32f954ca46dd4f6323ab2eef28455411b912aaf44a7c322", "bdc1abd0a07103cea34199a9c0d1020619136ff90fb88dcc3a8f873c811c1fe9", emptyList()),
            "rule3" to TargetHash("Rule", "c7018bbfed16f4f6f0ef1f258024a50c56ba916b3b9ed4f00972a233d5d11b42", "4aeafed087a9c78a4efa11b6f7831c38d775ddb244a9fabbf21d78c1666a2ea9", listOf("rule1")),
            "rule4" to TargetHash("Rule", "020720dfbb969ef9629e51a624a616f015fe07c7b779a5b4f82a8b36c9d3cbe9", "82b46404c8a1ec402a60de72d42a14f6a080e938e5ebaf26203c5ef480558767", listOf("rule1")),
        )
    }
    ...
    fun testCyclicRuleInput() = runBlocking {
        ...
        assertThat(hash).containsOnly(
            "rule1" to TargetHash("Rule", "7b3149cbd2219ca05bc80a557a701ddee18bd3bbe9afa8e851df64b999155c5e", "2c963f7c06bc1cead7e3b4759e1472383d4469fc3238dc42f8848190887b4775", emptyList()),
            "rule2" to TargetHash("Rule", "24f12d22ab247c5af32f954ca46dd4f6323ab2eef28455411b912aaf44a7c322", "bdc1abd0a07103cea34199a9c0d1020619136ff90fb88dcc3a8f873c811c1fe9", emptyList()),
            "rule3" to TargetHash("Rule", "be17f1e1884037b970e6b7c86bb6533b253a12d967029adc711e50d4662237e8", "91ea3015d4424bb8c1ecf381c30166c386c161d31b70967f3a021c1dc43c7774", listOf("rule1", "rule4")),
            "rule4" to TargetHash("Rule", "f3e5675e30fe25ff9b61a0c7f64c423964f886799407a9438e692fd803ecd47c", "bce09e1689cc7a8172653981582fea70954f8acd58985c92026582e4b75ec8d2", listOf("rule1")),
        )
    }
    ...
    fun testGeneratedTargetsDeps() = runBlocking {
        ...
        val depsMapping = hash.mapValues{ 
            it.value.deps
        }
        
        assertThat(depsMapping).containsOnly(
            "rule3" to listOf("rule0"),
            "rule0" to listOf("rule1"),
            "rule1" to emptyList<String>()
        )
    }
